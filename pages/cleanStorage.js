    ...
    {orderedCategories
      ...
      .map((cat) => (
        <React.Fragment key={`section-${cat}`}>
          <div className="w-full bg-[#5D1214] text-white py-2 px-4 rounded-md mt-6 mb-2">
          ...
          {groupedByCategory[cat].map((item, idx) => {
            ...
            return (
              <div
                key={rowKey}
                className="bg-gray-100 w-[100%] rounded-[30px] shadow-lg items-center justify-around flex gap-2 p-4"
              >
